...
def continue_with_salt():
    continueWindow = Toplevel()
    continueWindow.configure(bg="#282830")
    continueWindow.title("Encrypting")
    def encrypt_continue():
        window1 = Toplevel()
        ...
        def encrypt():
            ...
            token_converted = token.decode()
            #print(token_converted)
            #print(token)
    ...
    def decrypt_continue():
        ...
        encryptL2 = Label(window1, font="Helvetica 20 bold italic", bg="#282830", fg="#e92d2d", text="Insert your master password below:")
        encryptE2 = Entry(window1, fg="#e92d2d", font="Helvetica 15 bold italic", bd=0)
        encryptL3 = Label(window1, font="Helvetica 20 bold italic", bg="#282830", fg="#e92d2d", text="Message to decrypt:")
        encryptE3 = Entry(window1, fg="#e92d2d", font="Helvetica 15 bold italic", bd=0)
        encryptL1.place(rely=.2, relx=.5, anchor=CENTER)
        encryptE1.place(rely=.3, relx=.5, anchor=CENTER)
        encryptL2.place(rely=.4, relx=.5, anchor=CENTER)
        ...
        def decrypt():
            ...
            encrypted_message = Text(window_encrypted, bg='#282830', font='Helvetica 20 bold italic', fg='#e92d2d')
            encrypted_message.pack()
            encrypted_message.insert(1.0, f'Here is your decrypted message: {token_converted}')
        encryptB1 = Button(window1, bg="#282830", font="Helvetica 20 bold italic", relief=GROOVE, borderwidth=2, fg="#e92d2d", text="Decrypt", command=decrypt)
        encryptB1.place(rely=.9, relx=.5, anchor=CENTER)
    encryptB1 = Button(continueWindow, bg="#282830", font="Helvetica 20 bold italic", relief=GROOVE, borderwidth=2, fg="#e92d2d", text="Encrypt", command=encrypt_continue)
    encryptB1.place(rely=.3, relx=.5, anchor=CENTER)
    decryptB1 = Button(continueWindow, bg="#282830", font="Helvetica 20 bold italic", relief=GROOVE, borderwidth=2, fg="#e92d2d", text="Decrypt", command=decrypt_continue)
    decryptB1.place(rely=.6, relx=.5, anchor=CENTER)
